...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowAbout function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowAbout = False
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowColor function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowColor = False
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowFindFile function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CoTaskMemFree IDList_Path
    CoTaskMemFree IDList_Saved
    CD_ShowFindFile = False
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowFindReplace function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowFindComputer function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowFindComputer = False
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowFolder function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowFolder = False
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowFont function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowFont = False
    Resume FreeMemory
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowFormat function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowFormat = False
  End If
...
On Error GoTo ErrorTrap
  ...
  If HelpCommand <> HELP_HELPONHELP And HelpCommand <> HELP_QUIT Then
    ...
    ElseIf Dir(HelpFilePath) = "" Then
      '2.7.2 Logar todas mensagens
      msgboxL HelpFilePath & Chr(13) & Chr(13) & "Could not locate this file to open.  Make sure this file has not been renamed, moved, or deleted.", vbOKOnly + vbExclamation, "  File Not Found"
      Exit Function
    ElseIf UCase(Right(HelpFilePath, 3)) <> "HLP" Then
      '2.7.2 Logar todas mensagens
      msgboxL HelpFilePath & Chr(13) & Chr(13) & "Can not open this file because this file does not appear to be a WinHelp (.HLP) help file.", vbOKOnly + vbExclamation, "  Invalid WinHelp File"
      Exit Function
    End If
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowHelp function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowHelp = False
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowIcon function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowIcon = False
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowOpen_Save function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowOpen_Save = False
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowPageSetup function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowPageSetup = False
    Resume FreeMemory
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowPrinter function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowPrinter = False
    Resume FreeMemory
  End If
...
On Error GoTo ErrorTrap
  ...
  If FileName = "" And PrinterName = "" Then
    '2.7.2 Logar todas mensagens
    msgboxL "No path specified to display properties.", vbOKOnly + vbExclamation, "  Missing Parameter"
    Exit Function
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowProperties function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowProperties = False
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowReboot function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowReboot = False
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowRun function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowRun = False
  End If
...
ErrorTrap:
  ...
  Else                        ' Other Error
    '2.7.2 Logar todas mensagens
    msgboxL Err.Source & " encountered the following error in the CD_ShowShutDown function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(Err.Number) & Chr(13) & "Error Description = " & Err.Description, vbOKOnly + vbExclamation, "  Error  -  " & Err.Description
    Err.Clear
    CD_ShowShutDown = False
  End If
...
On Error Resume Next
  ...
  If ShowError = True Then
    '2.7.2 Logar todas mensagens
    msgboxL "COMDLG32.DLL encountered the following error while calling the '" & LastFunctionCalled & "' function:" & Chr(13) & Chr(13) & "Error Number = " & CStr(ReturnCode) & Chr(13) & "Error Description = " & TheMsg, vbOKOnly + vbExclamation, "  Common Dialog Error"
  End If
...
'******************************************************************************************
  ...
  If HelpButtonPressed = True Then
    '2.7.2 Logar todas mensagens
    msgboxL "Help Button Pressed", vbOKOnly + vbInformation, "Find/Replace Parameters"
    Exit Function
  End If
  ...
  With FRInfo
    ...
    '2.7.2 Logar todas mensagens
    msgboxL sTemp, vbOKOnly + vbInformation, "Find/Replace Parameters"
  End With
