...
Private KBytesProcessados As Integer
...
Function GetKBytesProcessados(cFrom As String) As Integer
GetKBytesProcessados = Val(GetPiece(cFrom, "|", 11)) / 1024
End Function
...
InializaZipError:
    '2.7.2 Logar todas mensagens
    msgboxL "Erro inicializando bibliotecas ZIP"
End Sub
